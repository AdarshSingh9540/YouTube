...
const Header = () => {
  ...
  return (
    <div className='grid grid-flow-col p-1 md:p-5 m-1 md:m-2 shadow-lg sticky top-0 z-10 h-20 bg-white' >
   <div className='flex col-span-1'>
   <img 
   onClick={()=>toggleMenuhandler()}
   className='h-9 md:h-11 mt-6 md:mt-0 ml-1 md:ml-0cursor-pointer'
    src="https://cdn.iconscout.com/icon/free/png-256/free-hamburger-menu-462145.png?f=webp"  
    alt="hamburger"
    />
<img 
className='h-12 m-4 md:m-0 ml-2 md:ml-6  mt-5 md:mt-0 md:mx-2 ' src="https://cdn.mos.cms.futurecdn.net/8gzcr6RpGStvZFA2qRt4v6-1200-80.jpg" alt=""
 />
   </div>
      <div className='col-span-10 px-10 mx-25'>
       <div >
        ...
        type="text"
         className='w-[50%] md:w-1/2 border border-gray-400 rounded-l-lg px-1 md:px-5 py-1 md:py-2 mt-6 md:mt-0 ml-12 md:ml-0'  placeholder='Search...'/>
        <button className='border border-gray-400 rounded-r-lg  md:px-5 py-1 md:py-2'>Search</button>
        </div>
